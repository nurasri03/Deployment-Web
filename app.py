...
def upload_file():
   if request.method == 'POST':
    ...
    ##########################################
    # Load classifier
    clf = joblib.load(os.path.join(os.path.dirname(os.path.realpath(__file__)),'modelRF.pkl'))
...
def extract_infos(fpath):
    res = {}
    pe = pefile.PE(fpath)
    res['e_magic'] = pe.IMAGE_DOS_HEADER.e_magic
    res['e_cblp'] = pe.IMAGE_DOS_HEADER.e_cblp
    res['e_cp'] = pe.IMAGE_DOS_HEADER.e_cp
    res['e_crlc'] = pe.IMAGE_DOS_HEADER.e_crlc
    res['e_cparhdr'] = pe.IMAGE_DOS_HEADER.e_cparhdr
    res['e_minalloc'] = pe.IMAGE_DOS_HEADER.e_minalloc
    res['e_maxalloc'] = pe.IMAGE_DOS_HEADER.e_maxalloc
    res['e_ss'] = pe.IMAGE_DOS_HEADER.e_ss
    res['e_sp'] = pe.IMAGE_DOS_HEADER.e_sp
    res['e_csum'] = pe.IMAGE_DOS_HEADER.e_csum
    res['e_ip'] = pe.IMAGE_DOS_HEADER.e_ip
    res['e_cs'] = pe.IMAGE_DOS_HEADER.e_cs
    res['e_lfarlc'] = pe.IMAGE_DOS_HEADER.e_lfarlc
    res['e_ovno'] = pe.IMAGE_DOS_HEADER.e_ovno
    res['e_res'] = pe.IMAGE_DOS_HEADER.e_res
    res['e_oemid'] = pe.IMAGE_DOS_HEADER.e_oemid
    res['e_oeminfo'] = pe.IMAGE_DOS_HEADER.e_oeminfo
    res['e_res2'] = pe.IMAGE_DOS_HEADER.e_res2
    try:
        res['e_lfanew'] = pe.IMAGE_DOS_HEADER.e_lfanew
    except AttributeError:
        res['e_lfanew'] = 0
        res['Machine'] = pe.FILE_HEADER.Machine
        res['NumberOfSections'] = pe.FILE_HEADER.NumberOfSections
        res['CreationYear'] = pe.FILE_HEADER.CreationYear
        ...
        res['MinorSubsystemVersion'] = pe.OPTIONAL_HEADER.BaseOfCode
